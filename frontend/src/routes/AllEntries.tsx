      ...
      {entries.map((entry: Entry, index: number) => {
        return (
          <div
            id={entry.id}
            key={index}
            className="bg-gray-300 dark:bg-slate-700 shadow-md shadow-gray-500 m-3 p-4 rounded flex flex-col justify-between dark:text-white"
          >
            ...
            <time className="text-center text-sm md:text-lg">
              <b>scheduled: </b>
